    ...
    Shape:
        ...
        if not self._qkv_same_embed_dim:
            return multi_head_attention_forward(
                ...
                v_proj_weight=self.v_proj_weight, out_dim=self.vdim, gaussian=gaussian)
        else:
            return multi_head_attention_forward(
                query, key, value, self.embed_dim, self.num_heads,
                self.in_proj_weight, self.in_proj_bias,
                ...
                training=self.training,
                key_padding_mask=key_padding_mask, need_weights=need_weights,
                attn_mask=attn_mask, out_dim=self.vdim, gaussian=gaussian)
...
def multi_head_attention_forward(query: Tensor,
    ...
    if gaussian is not None:
        attn_output_weights[..., :gaussian.shape[1]] = attn_output_weights[..., :gaussian.shape[1]] + gaussian.permute(2, 0, 1)
